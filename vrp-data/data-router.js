...
csrfRouter.post(`/${Misc.version}/misc/duplicates/:table`, Authorize.planner, Misc.m_checkDuplicates);
...
csrfRouter.get(`/${Vehicle.version}/vehicle/`, Authorize.planner, Vehicle.m_getAll);

csrfRouter.put(`/${Vehicle.version}/vehicle/:vehicleId`, Authorize.all, Vehicle.m_update);
router.put(`/${Vehicle.version}/vehicle/:vehicleId`, Authorize.all, Vehicle.m_update);
...
csrfRouter.get(`/${VehicleLocationLog.version}/vehicleLog/`, Authorize.planner, VehicleLocationLog.m_getAll);
