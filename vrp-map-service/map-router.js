...
csrfRouter.get('/v2/searchAddress', MeasureV2.m_searchSimilarAddress); // get addresses similar to input

csrfRouter.post('/v2/geocode', MeasureV2.m_searchAddressInDb, MeasureV2.m_geocode); // postal/address to lat/lng
