...
const DEFAULTS = Object.freeze({
    ...
    server: {
        ...
        urls: {
            ...
            static: [ // folders to be public by express
                ...
                { path: 'planner', folder: 'node_modules/@simtech/vrp-frontend-dist' },
                ...
                // apidoc
                { path: 'apidoc/v3', folder: 'public/apidoc-other/v3/html' },
                { path: 'apidoc/v1/data', folder: 'public/apidoc-data/v1/html' },
            ],
            routers: [ // @private
    ...
    log: { // https://github.com/log4js-node/log4js-node/tree/master/docs
        appenders: {
            ...
            tcpLogFile: { type: 'dateFile', filename: './log/vrp-tcp.out', daysToKeep: 2 }, // for main
            socketLogFile: { type: 'dateFile', filename: './log/vrp-socket.out', daysToKeep: 2 }, // for socket
    ...
    engine: {
        ...
        chinh: 'chinh-solver-3.6.6.jar',
        siwei: 'siwei-solver-6.9.6.jar',
    },
});

let configuration = DEFAULTS;

let userSettingsFile = 'setting.js';
