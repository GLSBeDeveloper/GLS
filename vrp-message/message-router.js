 ...
 * ================================================================================ */
router.post('/v2', Auth.m_isAuthDriver, Message.m_createMessages, Message.m_addUserDetails, Message.m_broadcastWSToPlanner); // create message

/* ================================================================================
 *  Middleware protected from CSRF
 * ================================================================================ */
csrfRouter.get('/v2', Auth.m_isAuthPlanner, Message.m_userGroupFilter, Message.m_getAll, Message.m_addUserDetails);
csrfRouter.get('/v2/unprocessedCount', Auth.m_isAuthPlanner, Message.m_userGroupFilter, Message.m_getTotalUnprocessedCount); // get number of unprocessed messages
